...
// Parse JSON body (necesario para req.body en POST)
app.use(express.json());

// POST /login — recibe { email, password } y devuelve idToken y datos del usuario
...
exports.authFunction = onRequest(authApiOptions, app);
